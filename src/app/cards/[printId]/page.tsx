      ...
      <main className="container mx-auto px-4 py-6 max-w-2xl">
        ...
        >
          ...
          <div className="relative aspect-[63/88] max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg">
            {card.image_url ? (
              <Image src={`/api/img/${printId}`} alt={card.name} fill className="object-cover" sizes="384px" unoptimized />
            ) : (
          ...
          {variants.length > 1 && (
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              {variants.map((v) => (
                ...
                >
                  {v.image_url ? (
                    <Image src={`/api/img/${v.id}`} alt={v.label} fill className="object-cover" sizes="64px" unoptimized />
                  ) : (
